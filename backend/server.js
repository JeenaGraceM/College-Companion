...
require('./models/confessions&polls/confessions');
require('./models/confessions&polls/LostFound');
require('./models/confessions&polls/Poll');
...
// Notes routes
app.use('/api/notes', require('./routes/notes&past_papers/notes'));

// Past Papers routes
app.use('/api/past_papers', require('./routes/notes&past_papers/past_papers'));
